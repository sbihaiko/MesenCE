...
- Status: accepted (2026-08-27, work requested via docs/roadmap/PRD-mesence-enhancement-ecosystem.md; was: small, actionable; not implemented — `render_original` is still NES-only and the only golden texture pack is GB; restored 2026-09-01 from b0b334b0^ after accidental deletion; work shipped 2026-08-28 as slice H4 of docs/roadmap/PRD-mesence-enhancement-ecosystem.md (`render_original(..., system)` dispatch in `scripts/mep_compare.py`, `docs/specs/golden/mep-nes/` present))
- Date: 2026-08-27
