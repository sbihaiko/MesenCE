...
- **Per-stage recording, the tooling half** (2026-09-12, F9.22): the
  ...
  is the measurement the slice was opened for. The states for the later
  stages are the human half and stay open.
