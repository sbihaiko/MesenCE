...
## Decision
ADR the placement decision (fingerprint field vs. OGG-side metadata) and the forward/backward-compatibility rule for packs written against MEP-v1 without the field.
